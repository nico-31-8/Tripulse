      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 mb-8">
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className={`text-xs px-2 py-0.5 rounded-full ${microciclo.tipo === 'Carga' ? 'bg-orange-900 text-orange-300' : microciclo.tipo === 'Recuperación' ? 'bg-green-900 text-green-300' : 'bg-blue-900 text-blue-300'}`}>{microciclo.tipo}</span>
          </div>
