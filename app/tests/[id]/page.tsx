...
export default function PaginaTests({ params }: { params: Promise<{ id: string }> }) {
  ...
  const formatCSS = (css: number) => {
    ...
    return `${min}:${s.toString().padStart(2, '0')} /100m`
  }
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          ...
          {mostrarFormLibre && (
            <form onSubmit={guardarTestLibre} className="bg-gray-900 rounded-xl p-6 mb-6 border border-gray-800 flex flex-col gap-4">
              ...
              <input type="text" placeholder="Nombre del test (ej: Test 5km, 1RM Press banca)" value={nombreLibre} onChange={e => setNombreLibre(e.target.value)} className="bg-gray-800 text-white px-4 py-3 rounded-lg outline-none focus:ring-2 focus:ring-orange-500" required />
