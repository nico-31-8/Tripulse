                  ...
                  <div className={'tp-collapse px-4 ' + (toolsOpen ? 'open pb-4' : '')}>
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {[
                        ...
                        /* Tus propios tests y tus propias zonas. Ya no ponen «en
                           pruebas»: desde que se puede prescribir con ellas son
                           parte de la aplicación como cualquier otra cosa, y
